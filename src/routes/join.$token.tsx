...
export const Route = createFileRoute("/join/$token")({
  ...
  head: () => ({
    meta: [
      { title: "Join a group — PARI" },
      { name: "description", content: "You've been invited to share expenses in PARI." },
      { property: "og:title", content: "Join a group — PARI" },
      {
        property: "og:description",
        content: "You've been invited to share expenses in PARI.",
      },
