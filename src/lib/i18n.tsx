...
const en: Dict = {
  ...
  "auth.err.invalidCredentials": "That email or password doesn't match an account.",
  "auth.err.emailTaken": "There's already an account with that email. Sign in instead.",
  "auth.err.weakPassword": "Choose a longer, less common password (at least 6 characters).",
  "auth.err.notConfirmed": "Confirm your email first — check your inbox for the link.",
  "auth.err.rateLimit": "Too many attempts. Wait a moment and try again.",
  "auth.err.linkExpired": "That link has expired or has already been used.",
  "auth.err.network": "No connection. Check your network and try again.",
  "auth.forgot": "Forgot your password?",
  "auth.resetTitle": "Reset your password",
  "auth.resetSubtitle": "We'll email you a secure link to choose a new password.",
  ...
  "auth.passwordChanged": "Your password is updated.",
...
const da: Dict = {
  ...
  "auth.err.invalidCredentials": "E-mail eller adgangskode passer ikke på en konto.",
  "auth.err.emailTaken": "Der findes allerede en konto med den e-mail. Log ind i stedet.",
  "auth.err.weakPassword": "Vælg en længere og mindre almindelig adgangskode (mindst 6 tegn).",
  "auth.err.notConfirmed": "Bekræft din e-mail først — tjek din indbakke for linket.",
  "auth.err.rateLimit": "For mange forsøg. Vent et øjeblik, og prøv igen.",
  "auth.err.linkExpired": "Linket er udløbet eller allerede brugt.",
  "auth.err.network": "Ingen forbindelse. Tjek dit netværk, og prøv igen.",
  "auth.forgot": "Glemt adgangskode?",
  "auth.resetTitle": "Nulstil din adgangskode",
  "auth.resetSubtitle": "Vi sender dig et sikkert link, hvor du vælger en ny adgangskode.",
  "auth.resetSend": "Send nulstillingslink",
  "auth.resetSent": "Hvis der findes en konto med den e-mail, er linket på vej.",
  "auth.backToSignIn": "Tilbage til log ind",
  "auth.newPassword": "Ny adgangskode",
  "auth.repeatPassword": "Gentag adgangskode",
  "auth.mismatch": "De to adgangskoder er ikke ens.",
  "auth.setPassword": "Gem ny adgangskode",
  "auth.passwordChanged": "Din adgangskode er opdateret.",
