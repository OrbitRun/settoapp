...
const en: Dict = {
  ...
  "activity.settlementPaid": "{from} paid {to}",
  "activity.payment": "Payment",
  "activity.paymentFrom": "From",
  "activity.paymentTo": "To",
  "activity.paymentAmount": "Amount",
  "activity.paymentRemaining": "Remaining",
  "activity.paymentNote": "Note",
  "activity.paymentSettled": "Settled up",
  ...
  "history.eventsOne": "1 event",
  "history.titleChanged": "Name",
  "history.amountChanged": "Amount",
  "history.payerChanged": "Payer",
  "history.groupChanged": "Group",
  "history.noGroup": "No group",
  "history.splitChanged": "Split",
  "history.peopleChanged": "People",
  "history.personAdded": "{name} added",
  "history.personRemoved": "{name} removed",
  "history.rateChanged": "Exchange rate",
  "history.items": "Items",
  "history.itemsChanged": "{count} items changed",
  "history.itemsChangedOne": "1 item changed",
  "history.itemAdded": "{name} added",
  "history.itemRemoved": "{name} removed",
  "history.moreChanges": "+{count} more",
  "history.shareOne": "share",
  "history.shareMany": "shares",
  ...
  "profile.hideAmounts": "Hide amounts",
  "profile.hideAmountsHint": "Hide balances and amounts when using Setto in public.",
  "profile.hideAmountsOn": "Show amounts",
  ...
  "profile.deleteAccountError": "The account could not be deleted. Please try again.",
  ...
  "groups.unarchive": "Reopen",
  "groups.archived": "Group archived",
  "groups.unarchived": "Group reopened",
  "groups.archivedTitle": "Archived",
  "groups.delete": "Delete group",
  "groups.deleteTitle": "Delete this group?",
  "groups.deleteBody":
    "Every expense, split and settlement in {group} is permanently removed. People are kept.",
  "groups.deleteConfirm": "Yes, delete the group",
  "groups.deleted": "Group deleted",
  "groups.memberHasExpenses": "This person has expenses in the group and can't be removed.",
  "groups.removeMember": "Remove from group",
  "groups.removeMemberTitle": "Remove {name}?",
  "groups.removeEmptyBody":
    "{name} has no expenses, splits or payments in this group and will be removed completely.",
  "groups.removeHistoryBody":
    "{name} has history in this group. All expenses, splits and payments are kept — the person just won't take part in new expenses.",
  "groups.removeOutstanding": "Outstanding balance is still shown until it's settled.",
  "groups.memberRemoved": "{name} was removed from the group.",
  "groups.memberDeactivated": "{name} no longer takes part. History is kept.",
  "groups.cannotRemoveSelf": "You can't remove yourself from your own group.",
  "groups.removeNotAllowed": "Only the group owner can remove members.",
  "groups.formerMembers": "Former members",
  "groups.formerMember": "Former member",
  "groups.restoreMember": "Add again",
  "groups.memberRestored": "{name} takes part again.",
  "groups.settings": "Group settings",
  "groups.addPerson": "+ Add person",
  "person.status": "Status",
  "person.balance": "Balance",
  "person.editName": "Edit name",
  "person.namePlaceholder": "Name",
  "person.nameSaved": "Name updated",
  ...
  "receipt.amountMatches": "The amount adds up",
  "receipt.uncertainName": "1 item name may be hard to read",
  "receipt.uncertainNames": "{count} item names may be hard to read",

  "currency.pick": "Currency",
  "currency.receiptCurrency": "Receipt currency",
  "currency.expenseCurrency": "Currency",
  "currency.detected": "Found on receipt",
  "currency.inferred": "Currency recognised from the receipt",
  ...
  "receipt.archiveTitle": "Receipts",
  "receipt.archivePrivacy": "Receipts are stored privately and are visible only to you.",
  "receipt.archiveEmptyTitle": "No receipts yet",
  "receipt.archiveEmptyBody": "Scan a receipt when you add an expense and it is kept here privately.",
  "receipt.searchMerchant": "Search by merchant",
  "receipt.unknownMerchant": "Receipt",
  "receipt.linked": "Linked to an expense",
  "receipt.notLinked": "Not linked",
  "receipt.note": "Note",
  "receipt.warranty": "Warranty until",
  "receipt.openExpense": "Open expense",
  "receipt.delete": "Delete receipt",
  "receipt.deleteConfirm": "This deletes the image and receipt details. The expense is kept.",
  "receipt.deleted": "Receipt deleted",
  "receipt.deleteFailed": "The receipt could not be deleted. Try again.",
  "receipt.updateFailed": "The receipt could not be saved. Try again.",
  ...
  "auth.resetBody": "We'll send you a link to choose a new password.",
  ...
  "auth.emailInUse": "That email already has an account. Try signing in.",
  "auth.weakPassword": "Choose a longer password — at least 6 characters.",
  "auth.emailNotConfirmed": "Confirm your email first — check your inbox.",
  "auth.rateLimited": "Too many attempts. Wait a moment and try again.",
  "auth.offline": "No connection. Check your network and try again.",
  "auth.inviteContext": "Sign in to accept your invitation.",
  ...
  "invite.expiredBody": "Ask for a new invitation link or join code.",
  "invite.revokedTitle": "This invitation was withdrawn",
  "invite.revokedBody": "Ask the group for a new invitation.",
  "invite.completing": "Completing your invitation…",
  ...
  "firstRun.title": "How Setto works",
  "firstRun.intro": "Share expenses, keep track of who owes what, and settle easily.",
  "firstRun.step1Title": "Create or pick a group",
  "firstRun.step1Body": "Gather the people you share expenses with.",
  "firstRun.step2Title": "Add an expense",
  "firstRun.step2Body": "Enter it manually or scan a receipt.",
  "firstRun.step3Title": "Settle up",
  "firstRun.step3Body": "Setto keeps the balance until you're even.",
  ...
  "celebrate.title": "All settled up.",
  "celebrate.subtitle": "You're even.",
  "celebrate.settledAmount": "Settled",
  "celebrate.balanceNow": "Balance",
  "celebrate.balanceZero": "Zero",
  "celebrate.done": "Done",
  "celebrate.viewSummary": "View summary",
  "celebrate.pairSettled": "{from} and {to} are even.",
  ...
  "split.percentTotalOk": "Total 100%",
  "split.percentTotal": "Total {value}%",
  "split.percentRemaining": "{value}% remaining",
  "split.percentOver": "{value}% too much",
  "split.sharesTotal": "{count} shares in total",
  "split.usingGroupDefault": "Using {group}'s default split",
  "split.changeSplit": "Change split",
  "split.byItemHint": "Assign each line to the people who had it",
...
const da: Dict = {
  ...
  "common.done": "Færdig",
  "common.delete": "Slet",
  "common.saveFailed": "Kunne ikke gemme. Prøv igen.",
  "common.edit": "Redigér",
  "common.close": "Luk",
  ...
  "activity.settlementPaid": "{from} betalte {to}",
  "activity.payment": "Betaling",
  "activity.paymentFrom": "Fra",
  "activity.paymentTo": "Til",
  "activity.paymentAmount": "Beløb",
  "activity.paymentRemaining": "Resterende",
  "activity.paymentNote": "Note",
  "activity.paymentSettled": "Gjort op",
  ...
  "history.events": "{count} hændelser",
  "history.eventsOne": "1 hændelse",
  "history.titleChanged": "Navn",
  "history.amountChanged": "Beløb",
  "history.payerChanged": "Betaler",
  "history.groupChanged": "Gruppe",
  "history.noGroup": "Ingen gruppe",
  "history.splitChanged": "Fordeling",
  "history.peopleChanged": "Personer",
  "history.personAdded": "{name} tilføjet",
  "history.personRemoved": "{name} fjernet",
  "history.rateChanged": "Valutakurs",
  "history.items": "Varer",
  "history.itemsChanged": "{count} varer ændret",
  "history.itemsChangedOne": "1 vare ændret",
  "history.itemAdded": "{name} tilføjet",
  "history.itemRemoved": "{name} fjernet",
  "history.moreChanges": "+{count} mere",
  "history.shareOne": "andel",
  "history.shareMany": "andele",
  ...
  "profile.hideAmounts": "Skjul beløb",
  "profile.hideAmountsHint": "Skjul saldoer og beløb, når du bruger Setto offentligt.",
  "profile.hideAmountsOn": "Vis beløb",
  ...
  "profile.deleteAccountError": "Kontoen kunne ikke slettes. Prøv igen.",
  "profile.system": "System",
  "profile.light": "Lys",
  "profile.dark": "Mørk",
  ...
  "groups.edit": "Redigér gruppe",
  "groups.saved": "Gruppen er gemt",
  "groups.archive": "Arkivér gruppe",
  "groups.unarchive": "Genåbn",
  "groups.archived": "Gruppen er arkiveret",
  "groups.unarchived": "Gruppen er genåbnet",
  "groups.archivedTitle": "Arkiverede",
  "groups.delete": "Slet gruppe",
  "groups.deleteTitle": "Slet gruppen?",
  "groups.deleteBody":
    "Alle udgifter, opdelinger og opgør i {group} bliver slettet permanent. Personerne beholdes.",
  "groups.deleteConfirm": "Ja, slet gruppen",
  "groups.deleted": "Gruppen er slettet",
  "groups.memberHasExpenses": "Personen har udgifter i gruppen og kan ikke fjernes.",
  "groups.removeMember": "Fjern fra gruppen",
  "groups.removeMemberTitle": "Fjern {name}?",
  "groups.removeEmptyBody":
    "{name} har ingen udgifter, fordelinger eller betalinger i gruppen og fjernes helt.",
  "groups.removeHistoryBody":
    "{name} har historik i gruppen. Alle udgifter, fordelinger og betalinger bevares — personen deltager bare ikke i nye udgifter.",
  "groups.removeOutstanding": "Udestående saldo vises stadig, indtil den er gjort op.",
  "groups.memberRemoved": "{name} blev fjernet fra gruppen.",
  "groups.memberDeactivated": "{name} deltager ikke længere. Historikken er bevaret.",
  "groups.cannotRemoveSelf": "Du kan ikke fjerne dig selv fra din egen gruppe.",
  "groups.removeNotAllowed": "Kun gruppens ejer kan fjerne medlemmer.",
  "groups.formerMembers": "Tidligere medlemmer",
  "groups.formerMember": "Tidligere medlem",
  "groups.restoreMember": "Tilføj igen",
  "groups.memberRestored": "{name} deltager igen.",
  "groups.settings": "Gruppeindstillinger",
  "groups.addPerson": "+ Tilføj person",
  "person.status": "Status",
  "person.balance": "Saldo",
  "person.editName": "Redigér navn",
  "person.namePlaceholder": "Navn",
  "person.nameSaved": "Navnet er opdateret",
  "settle.title": "Gør op",
  ...
  "receipt.archiveTitle": "Kvitteringer",
  "receipt.archivePrivacy": "Kvitteringer gemmes privat og er kun synlige for dig.",
  "receipt.archiveEmptyTitle": "Ingen kvitteringer endnu",
  "receipt.archiveEmptyBody": "Scan en kvittering, når du tilføjer en udgift — så gemmes den privat her.",
  "receipt.searchMerchant": "Søg efter butik",
  "receipt.unknownMerchant": "Kvittering",
  "receipt.linked": "Knyttet til en udgift",
  "receipt.notLinked": "Ikke knyttet",
  "receipt.note": "Note",
  "receipt.warranty": "Garanti indtil",
  "receipt.openExpense": "Åbn udgift",
  "receipt.delete": "Slet kvittering",
  "receipt.deleteConfirm": "Dette sletter billedet og kvitteringens detaljer. Udgiften bevares.",
  "receipt.deleted": "Kvittering slettet",
  "receipt.deleteFailed": "Kvitteringen kunne ikke slettes. Prøv igen.",
  "receipt.updateFailed": "Kvitteringen kunne ikke gemmes. Prøv igen.",
  ...
  "auth.subtitle": "Del udgifter. Gør nemt op.",
  "auth.email": "E-mail",
  ...
  "auth.toSignUp": "Ny på Setto? Opret konto",
  ...
  "auth.resetBody": "Vi sender dig et link, så du kan vælge en ny adgangskode.",
  "auth.resetSend": "Send nulstillingslink",
  "auth.resetSent": "Hvis mailen har en konto, er linket på vej.",
  "auth.newPassword": "Ny adgangskode",
  "auth.confirmPassword": "Gentag ny adgangskode",
  ...
  "auth.checkingLink": "Tjekker dit link…",
  "auth.invalidCredentials": "Forkert e-mail eller adgangskode.",
  "auth.emailInUse": "Der findes allerede en konto med den mail. Prøv at logge ind.",
  "auth.weakPassword": "Vælg en længere adgangskode — mindst 6 tegn.",
  "auth.emailNotConfirmed": "Bekræft din mail først — tjek din indbakke.",
  "auth.rateLimited": "For mange forsøg. Vent lidt, og prøv igen.",
  "auth.offline": "Ingen forbindelse. Tjek dit netværk, og prøv igen.",
  "auth.inviteContext": "Log ind for at tage imod din invitation.",
  ...
  "invite.expiredBody": "Bed om et nyt invitationslink eller en ny join-kode.",
  "invite.revokedTitle": "Invitationen er trukket tilbage",
  "invite.revokedBody": "Bed gruppen om en ny invitation.",
  "invite.completing": "Fuldfører din invitation…",
  ...
  "welcome.subtitle": "Fra kvittering til afregning – uden besværet.",
  ...
  "firstRun.title": "Sådan virker Setto",
  "firstRun.intro": "Del udgifter, hold styr på hvem der skylder hvad, og gør nemt op.",
  "firstRun.step1Title": "Opret eller vælg en gruppe",
  "firstRun.step1Body": "Saml dem, du deler udgifter med.",
  "firstRun.step2Title": "Tilføj en udgift",
  "firstRun.step2Body": "Indtast den manuelt eller scan en kvittering.",
  "firstRun.step3Title": "Gør op",
  "firstRun.step3Body": "Setto holder styr på saldoen, indtil I er lige.",
  "firstRun.cta": "Kom i gang",
  "firstRun.skip": "Spring over",
  ...
  "settle.registerPayment": "Registrér betaling",
  "settle.amount": "Beløb",
  "settle.outstanding": "Resterende saldo",
  "settle.afterPayment": "Efter betaling",
  "settle.remainingAfter": "{amount} tilbage",
  "settle.tooMuch": "Beløbet kan ikke være større end det resterende beløb.",
  "settle.mustBePositive": "Beløbet skal være større end 0.",
  "settle.note": "Note",
  "settle.notePlaceholder": "MobilePay, bankoverførsel …",
  "settle.paymentRegistered": "Betaling registreret",
  "celebrate.title": "Alt er gjort op.",
  "celebrate.subtitle": "I er lige.",
  "celebrate.settledAmount": "Gjort op",
  "celebrate.balanceNow": "Saldo",
  "celebrate.balanceZero": "Nul",
  "celebrate.done": "Færdig",
  "celebrate.viewSummary": "Se oversigt",
  "celebrate.pairSettled": "{from} og {to} er lige.",
  ...
  "split.percentTotalOk": "I alt 100%",
  "split.percentTotal": "I alt {value}%",
  "split.percentRemaining": "{value}% mangler",
  "split.percentOver": "{value}% for meget",
  "split.sharesTotal": "{count} dele i alt",
  "split.usingGroupDefault": "Bruger {group}s standardfordeling",
  "split.changeSplit": "Skift fordeling",
  "split.byItemHint": "Tildel hver vare til dem, der fik den",
